(() => {
  ...
  uaeButton.textContent = "Send to WhatsApp UAE";
  uaeButton.dataset.whatsapp = "971565565774";
  const jordanButton = uaeButton.cloneNode(true);
  jordanButton.textContent = "Send to WhatsApp Jordan";
  jordanButton.dataset.whatsapp = "971555533432";

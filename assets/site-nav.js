(() => {
  ...
  const productMenu = `<details class="product-menu"${["products.html","chandeliers.html"].includes(current)?' data-active="true"':""}><summary>Products</summary><div class="product-submenu"><a${current==="products.html"?' class="active" aria-current="page"':""} href="products.html">Product Catalogue</a><a${current==="chandeliers.html"?' class="active" aria-current="page"':""} href="chandeliers.html">Chandeliers</a><a href="products.html#downloads">Datasheet Downloads</a></div></details>`;
  links.splice(3,0,productMenu);
  header.innerHTML = `<div class="container nav"><a class="brand brand-logo" href="index.html" aria-label="ESHBELIA SARABI home"><img src="assets/brand/live-mark.png" alt=""><span><strong>ESHBELIA SARABI</strong><small>LIGHTING &amp; CABLE SOLUTIONS</small></span></a><button class="menu-btn site-menu-btn" type="button" aria-expanded="false" aria-controls="siteNav"><span></span><span></span><span></span><b>Menu</b></button><nav id="siteNav" class="navlinks site-nav" aria-label="Main navigation">${links.join("")}<button id="langBtn" class="lang" type="button">العربية</button><a class="nav-quote" href="contact.html">Request a Quote</a></nav></div>`;

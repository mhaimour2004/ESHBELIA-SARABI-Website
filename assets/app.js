(() => {
  ...
  function initCatalogueDialog() {
    ...
    $("#chandelierGrid").addEventListener("click", (event) => {
      ...
      $("#dialogWhatsApp").href = `https://wa.me/971565565774?text=${encodeURIComponent(`Hello ESHBELIA SARABI, I would like to enquire about ${item.name} (${item.code}).`)}`;
      dialog.showModal();
    });
